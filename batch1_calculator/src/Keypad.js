function Keypad({handleClick,handleClear,resultCal,handleClearSingle,handleSqrt}){
    return(
        <>
            <div className="row">
            ...
            <div className="row">
                ...
                <button className="fun-key" onClick={()=>{resultCal()}}>=</button>
            ...
            <div className="row">
                ...
                <button className="digit" onClick={()=>{handleClick("%")}}>%</button>
                <button className="fun-key" onClick={()=>{handleSqrt()}}>x<sup>2</sup></button>
                <button className="operator" onClick={()=>{handleClearSingle()}}> &larr; </button>
            </div>
        </>
    )
}
